...
export const searchDocumentAPI = (currentPage, keyword) => {
  return backendApi.get(
    `/api/document/searchDocument/${currentPage}/${keyword}`
  );
};

export const searchHistoryDocumentAPI = (currentPage, keyword) => {
  return backendApi.get(
    `/api/document/searchHistoryDocument/${currentPage}/${keyword}`
  );
};

export const searchUnApprovedDocumentAPI = (currentPage, keyword) => {
  return backendApi.get(
    `/api/document/searchUnApprovedDocument/${currentPage}/${keyword}`
  );
};
...
export const getDocumentDetailByIdAPI = (documentId) => {
  return backendApi.get(`/api/document/getDocumentDetail/${documentId}`);
};
